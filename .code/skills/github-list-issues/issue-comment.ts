...
if (!owner || !repo || !issueNumber || !comment) {
  ...
  console.error('Uso: npx ts-node issue-comment.ts --owner <owner> --repo <repo> --issue-number <num> --comment "texto"');
  process.exit(1);
}
...
async function main() {
  console.log(`💬 Adicionando comentário na issue #${issueNumber}...`);
